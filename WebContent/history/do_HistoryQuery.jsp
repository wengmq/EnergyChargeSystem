...
%> 
 ...
 <br>  
 <a href="PersonalHistory.jsp?showPage=1">首页</a>  
 <a href="PersonalHistory.jsp?showPage=<%=showPage-1%>">上一页</a>  
<%  
     //根据pageCount的值显示每一页的数字并附加上相应的超链接  
     for(int i=1;i<=pageCount;i++){  
%>  
         <a href="PersonalHistory.jsp?showPage=<%=i%>"><%=i%></a>  
<%   
    }  
%>     
 <a href="PersonalHistory.jsp?showPage=<%=showPage+1%>">下一页</a>  
 <a href="PersonalHistory.jsp?showPage=<%=pageCount%>">末页</a>  
 <!-- 通过表单提交用户想要显示的页数 -->  
